...
const val VARIABLE_BRIGHTNESS_FACTOR = 0.8
...
fun String.color(color: TextColor): String {
    return "<${color.asHexString()}>$this</${color.asHexString()}>"
}

fun String.color(hexColor: String): String {
    var hexColor = hexColor
    if (!hexColor.startsWith("#")) {
        hexColor = "#$hexColor"
    }
    return "<${hexColor}>$this</${hexColor}>"
}
